...
var Product = function Product(name, price, description) {
...
function () {
  ...
  _createClass(Products, [{
    key: "createProducts",
    value: function createProducts(product) {
...
var _product = _interopRequireDefault(require("../js/product"));

var _products = _interopRequireDefault(require("../js/products"));
...
productForm.addEventListener('submit', function (e) {
  ...
  var price = document.getElementById('product-price').value;
  var description = document.getElementById('product-description').value;
  var productTotal = document.getElementById('price-total');

  if (name === '' || price === '' || price <= 0 || description === '') {
    return;
  }

  var product = new _product.default(name, price, description);
  total += +price;
  ...
  var productUi = document.getElementById('product-ui');
  productUi.addEventListener('click', function (e) {
    var products = new _products.default();
...
},{"../js/product":"js/product.js","../js/products":"js/products.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
